...
/**
 * Displays robot X, Y, and Theta positional parameters on LCD. This class was made a thread as we
 * did not want it to momentarly stop or have to call a method constantly in other classes.
 */
